#Automatisation pour la récupération des données
...
# Planifier l'extraction des données une fois par jour à une heure précise
schedule.every().day.at("10:00").do(extract_job_data)
# Boucle d'exécution pour que le script s'exécute indéfiniment
while True:
